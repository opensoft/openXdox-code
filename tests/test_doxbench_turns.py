...
from opendox_bundle import web as opendox_web  # noqa: E402  (PER-TEST skip)
...
# the bundle, on the module this file already imports as `doxbench_turns`.
MODULE_PATH = pathlib.Path(doxbench_turns.__file__)
